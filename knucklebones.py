...
class View:
    def __init__(self):
        ...
        self.score_label = tk.Label(self.score_frame, font=("Courier New", 30))
    ...
    def change_score(self, enemy_score, player_score):
        self.score_label["text"] = f"Knucklebones\nComputer - Player\n{enemy_score} - {player_score}"

    def change_score_at_win(self, won_status, enemy_score, player_score):
        self.score_label["text"] = f"{['Computer won!', 'Player won!', 'Draw!'][won_status]}\nComputer - Player\n{enemy_score} - {player_score}"
...
class Controller:
    ...
    def main(self):
        ...
        if self.model.player_dices == 9:
            self.end_of_game(self.model.enemy_score <= self.model.player_score, self.model.enemy_score == self.model.player_score)
            return None
    ...
    def end_of_game(self, won, are_equal):
        self.view.change_score_at_win(won + are_equal, self.model.enemy_score, self.model.player_score)
